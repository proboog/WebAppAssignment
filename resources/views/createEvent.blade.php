...
<body>
    ...
    <div class="w3-container w3-half w3-margin-top">
        ...
        <form class="w3-container w3-card-4">
            ...
            <p>
                <textarea class="w3-input" rows="4" cols="50" style="width:90%" required>
                </textarea>
                <label>Event description</label>
            </p>

            <p>
                <select class="w3-select" name="type of event">
            ...
            <p>
                <input class="w3-input" type="datetime-local" name="date and time">
            ...
            <p>
                <input class="w3-input" type="text" name="organiser name">
                <label>Organiser name</label>
            </p>
                <input class="w3-input" type="text" name="contact number">
